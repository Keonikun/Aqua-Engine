export class InputManager {
  constructor({ canvas }) {
    ...
    this.mouseSensitivityScale = 1
    this.mouseSensitivity = this.baseMouseSensitivity
    ...
    this.onCanvasClick = () => this.canvas.requestPointerLock()
  }
  ...
  setMouseSensitivityScale(scale) {
    this.mouseSensitivityScale = scale
    this.mouseSensitivity = this.baseMouseSensitivity * scale
  }
}
